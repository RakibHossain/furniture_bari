...
<div class="filterable">
    ...
    <div class="pull-right">
        <a href="<?= base_url("worker/create/pay/bill") ?>" class="btn btn-info btn-xm"><span class="glyphicons glyphicons-plus"></span> Add New</a>
        ...
        <tbody>
            ...
            <?php foreach ($pay_bills as $key => $pay_bill): ?>
                ...
                <tr>
                    ...
                    <td><?= $pay_bill->po_id ?></td>
                    <td><?= $pay_bill->worker ?></td>
                    <td><?= $pay_bill->payment_type ?></td>
                    <td><?= $pay_bill->account ?></td>
                    <td><?= $pay_bill->amount ?></td>
                    <td>
                        <a href="<?= base_url("worker/edit/pay/bill/$pay_bill->id") ?>" class="btn btn-success">Edit</a>
                        <?php if (($this->session->userdata['logged_in']['role'] == 1) || ($this->session->userdata['logged_in']['role'] == 5)): ?>
                            <a href="<?= base_url("worker/delete/pay/bill/$pay_bill->id") ?>" class="btn btn-danger">Delete</a>
                        <?php endif ?>
                    </td>
                </tr>
