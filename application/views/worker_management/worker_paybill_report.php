...
<?php if ($type == 'new'): ?>
    ...
    <form class="form-horizontal" id="formRoot" action="<?= base_url("worker/paybill/report/filter") ?>" method="POST">
        ...
        <table class="table">
            ...
            <thead>
                ...
                <tr class="filters">
                    ...
                    <th><input type="text" class="form-control" placeholder="Pay Bill" disabled></th>
            ...
            <tbody id="rows">
                ...
                <?php foreach ($worker_paybill_reports as $key => $worker_paybill_report): ?>

                    <tr>
                        <td><?= ++$key ?></td>
                        <td><?= date("m/d/Y", strtotime($worker_paybill_report->date)) ?></td>
                        <td><?= $worker_paybill_report->amount ?></td>
                        <td><?= $worker_paybill_report->payment_type ?></td>
                    </tr>
