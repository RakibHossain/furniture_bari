...
<div class="filterable">
    ...
    <div class="pull-right">
        <a href="<?= base_url("purchase/create/bill") ?>" class="btn btn-info btn-xm"><span class="glyphicons glyphicons-plus"></span> Add New</a>
        ...
        <tbody>
            ...
            <?php foreach ($bills as $key => $bill): ?>
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?= base_url("purchase/edit/bill/$bill->id") ?>" class="btn btn-success"><i class="fa fa-edit"></i></a>
                        <?php if ($this->session->userdata['logged_in']['role'] == 1): ?>
                            <a href="<?= base_url("purchase/delete/bill/$bill->id") ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                        <?php endif ?>
                    </td>
                </tr>
