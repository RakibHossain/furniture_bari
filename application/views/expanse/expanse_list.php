                ...
                <tbody>
                    ...
                    <?php foreach ($expanses as $key => $expanse): ?>
                        ...
                        <tr>
                            ...
                            <td><?= $expanse->user_type ?></td>
                            <td><?= $expanse->net_total ?></td>
                            <td><?= $expanse->remark ?></td>
                            <td>
                                <a href="<?= base_url("admin/new/expanse/edit/$expanse->id") ?>" class="btn btn-success"><i class="fa fa-edit"></i></a>
                                <?php if ($this->session->userdata['logged_in']['role'] == 1): ?>
                                    <a href="<?= base_url("admin/new/expanse/delete/$expanse->id") ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                <?php endif ?>
                            </td>
                        </tr>
